...
product8 = Product.new(name:"Compote de pommes",description:"Pour petits et grands ! Toutes les compotes Goûts dFruits sont sans morceaux et contiennent peu de sucre ajouté.", unit_price_cents: 380, unit_price_cents_shop: 330, unit_type:"pot", unit_measure:"g", unit_measure_quantity:"450",unit_measure_quantity_shop:"450", product_fruit: "pomme", product_type:"compote", product_category:"Gourmandise")
