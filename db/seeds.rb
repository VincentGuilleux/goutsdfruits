...
product1 = Product.new(name:"Cerises au sirop", description:"Dénoyautées, les cerises au sirop sont prêtes pour vos clafoutis ou pour égayer salades de fruits frais.", unit_price_cents: 600, unit_price_cents_shop: 522, unit_type:"pot de 850 ml", product_fruit: "cerise", product_type:"fruit au sirop", product_category:"Gourmandise")
...
product2 = Product.new(name: "Prunes au sirop",description: "Dénoyautées,les prunes au sirop sont prêtes pour vos clafoutis ou pour pour vos desserts", unit_price_cents: 600,  unit_price_cents_shop: 522, unit_type:"pot de 850 ml", product_fruit: "prune", product_type:"fruit au sirop", product_category:"Gourmandise")
...
product13 = Product.new(name:"Gelée de cassis",description:"Sur les crêpes, les tartines, de la brioche, la gelée de cassis ensoleille vos goûters et petits déjeuners.", unit_price_cents: 320, unit_price_cents_shop: 278, unit_type:"pot de 220g",product_fruit: "cassis", product_type:"gelée", product_category:"Gourmandise")
...
product14 = Product.new(name:"Gelée de coings",description:"Allégée en sucre pour retrouver toute la saveur du coing.", unit_price_cents: 320, unit_price_cents_shop: 278, unit_type:"pot de 220g",product_fruit: "coing", product_type:"gelée", product_category:"Gourmandise")
...
product15 = Product.new(name:"Gelée de groseilles",description:"Sur les crêpes, les tartines, de la brioche, la gelée de groseille ensoleille vos goûters et petits déjeuners.", unit_price_cents: 320, unit_price_cents_shop: 278, unit_type:"pot de 220g",product_fruit: "groseille", product_type:"gelée", product_category:"Gourmandise")
...
product16 = Product.new(name:"Gelée de mûres",description:"Allégée en sucre pour retrouver toute la saveur de la mûre sauvage.", unit_price_cents: 320, unit_price_cents_shop: 278, unit_type:"pot de 220g",product_fruit: "mûre", product_type:"gelée", product_category:"Gourmandise")
...
product17 = Product.new(name:"Gelée de sureau",description:"Allégée en sucre pour retrouver toute la saveur de la fleur de sureau.", unit_price_cents: 320, unit_price_cents_shop: 278, unit_type:"pot de 220g",product_fruit: "sureau", product_type:"gelée", product_category:"Gourmandise")
...
product19 = Product.new(name:"Sirop de menthe",description:"Rafraîchissez vous avec ce sirop de menthe. A diluer dans 9 fois son volume d'eau ou de lait !", unit_price_cents: 650, unit_price_cents_shop: 565, unit_type:"bouteille de 50 cl", product_fruit: "menthe", product_type:"sirop", product_category:"Gourmandise")
...
product20 = Product.new(name:"Sirop de pêches",description:"Rafraîchissez vous avec ce sirop de menthe. A diluer dans 9 fois son volume d'eau ou de lait !", unit_price_cents: 650, unit_price_cents_shop: 565, unit_type:"bouteille de 50 cl", product_fruit: "pêche", product_type:"sirop", product_category:"Gourmandise")
...
product21 = Product.new(name:"Sirop de poires",description:"Rafraîchissez vous avec ce sirop de menthe. A diluer dans 9 fois son volume d'eau ou de lait !", unit_price_cents: 650, unit_price_cents_shop: 565, unit_type:"bouteille de 50 cl", product_fruit: "poire", product_type:"sirop", product_category:"Gourmandise")
...
product22 = Product.new(name:"Sirop de sureau",description:"Rafraîchissez vous avec ce sirop de sureau. A diluer dans 9 fois son volume d'eau ou de lait !", unit_price_cents: 650, unit_price_cents_shop: 565, unit_type:"bouteille de 50 cl", product_fruit: "sureau", product_type:"sirop", product_category:"Gourmandise")
...
product23 = Product.new(name:"Sorbet fraise", description:"Préparé avec des fraises bien mûres, le sorbet doit être sorti du congélateur 10 minutes avant sa dégustation pour révéler sa texture onctueuse.", unit_price_cents: 700, unit_price_cents_shop: 609, unit_type:"pot de 50 cl", product_fruit: "fraise", product_type:"sorbet", product_category:"Gourmandise")
...
product24 = Product.new(name: "Sorbet pêche",description: "Préparé avec des pêches bien mûres, le sorbet doit être sorti du congélateur 10 minutes avant sa dégustation pour révéler sa texture onctueuse", unit_price_cents: 700,  unit_price_cents_shop: 609, unit_type:"pot de 50 cl", product_fruit: "pêche", product_type:"sorbet", product_category:"Gourmandise")
...
product25 = Product.new(name:"Sorbet poire",description:"Préparé avec des poires bien mûres, le sorbet doit être sorti du congélateur 10 minutes avant sa dégustation pour révéler sa texture onctueuse.", unit_price_cents: 700, unit_price_cents_shop: 609, unit_type:"pot de 50 cl", product_fruit: "poire", product_type:"sorbet", product_category:"Gourmandise")
...
product26 = Product.new(name:"Sorbet sureau",description:"Préparé avec des fleurs de sureau, le sorbet doit être sorti du congélateur 10 minutes avant sa dégustation pour révéler sa texture onctueuse.", unit_price_cents: 700, unit_price_cents_shop: 609, unit_type:"pot de 50 cl", product_fruit: "sureau", product_type:"sorbet", product_category:"Gourmandise")
...
product35 = Product.new(name:"Pommes Clochardes",description:"La pomme clocharde originaire de Gâtine est ferme et sucrée. Elle se conserve très bien.", unit_price_cents: 250, unit_price_cents_shop: 1200, unit_type:"sachet de 1 kg", unit_type_shop:"sachet de 5 kg", product_fruit: "pomme", product_type:"fruit", product_category:"Fruit frais")
...
product38 = Product.new(name:"Coings",description:"Pour accompagner les volailles ou se lancer dans la fameuse gelée de coing.", unit_price_cents: 300, unit_price_cents_shop: 1000, unit_type:"sachet de 1 kg", unit_type_shop:"sachet de 3 kg",product_fruit: "coing", product_type:"fruit", product_category:"Fruit frais")
