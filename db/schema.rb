...
ActiveRecord::Schema.define(version: 2020_05_29_060835) do
  ...
  create_table "orders", force: :cascade do |t|
    ...
    t.datetime "updated_at", precision: 6, null: false
    t.date "pickup_date"
    t.bigint "delivery_place_id", null: false
    t.index ["client_id"], name: "index_orders_on_client_id"
    t.index ["delivery_place_id"], name: "index_orders_on_delivery_place_id"
  end
  ...
  create_table "products", force: :cascade do |t|
    ...
    t.integer "unit_measure_quantity"
    t.integer "unit_measure_quantity_shop"
  end
  ...
  add_foreign_key "orders", "delivery_places"
